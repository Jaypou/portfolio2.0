        ...
        >
          <div className="relative h-full w-full overflow-hidden">
            <div className="absolute inset-0 h-full w-full">
              ...
              />
              <div
                className={`absolute inset-0 duration-500 ease-in-out transition-background ${hoveredIndex === index ? "bg-black/40" : "bg-black/60"}`}
              />
            </div>
            ...
            <div
              ...
              className={`relative z-10 flex h-full w-full items-center justify-center overflow-y-auto opacity-0 scrollbar-hide`}
            >
              <div className="max-h-full w-full max-w-full">{item.content}</div>
            </div>
          </div>
