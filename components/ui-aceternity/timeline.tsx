  ...
  return (
    <div className="w-full font-sans" ref={containerRef}>
      {/* <div className="mx-auto max-w-7xl px-4 py-20 md:px-8 lg:px-10">
        <h2 className="mb-4 max-w-4xl text-lg text-red-500 md:text-4xl">
          Changelog from my journey
        </h2>
        <p className="max-w-sm text-sm text-red-500 md:text-base">
      ...
      <div ref={ref} className="relative mx-auto max-w-7xl">
        {data.map((item, index) => (
          ...
          >
            <div className="sticky top-40 z-40 flex w-20 flex-col items-center self-start md:w-48">
              ...
              <h3 className="hidden text-xl font-bold text-green-500 md:block md:pl-20 md:text-5xl">
                {item.title}
              </h3>
            </div>

            <div className="relative flex-1 pl-4 pr-4 md:pl-4">
